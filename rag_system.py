...
class RAGSystem:
    ...
    def generate_response(self, query: str):
        ...
        prompt = f"""Ты - ассистент компании. Ответь на вопрос сотрудника, используя только предоставленный контекст. 
        Если ответа нет в контексте, скажи "Не могу найти информацию в базе знаний".
